  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <section className="relative w-full overflow-hidden bg-primary/5 pt-8 pb-12 lg:pt-12 lg:pb-20">
        ...
        <div className="absolute top-0 right-0 -translate-y-12 translate-x-1/3 w-96 h-96 bg-brand-primary-light/20 rounded-full blur-3xl opacity-50" />
        ...
        <div className="container relative z-10 px-4 sm:px-6 lg:px-8 mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
            <div className="max-w-2xl space-y-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-4 pb-8 sm:pb-0 justify-center lg:justify-start">
            ...
            <div className="relative hidden lg:block h-[600px] w-full rounded-3xl overflow-hidden glass shadow-2xl p-4">
              {/* Hero Image Placeholder (Would use an actual Image here) */}
